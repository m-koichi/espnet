...
from evaluation_measures import get_f_measure_by_class, compute_strong_metrics, get_predictions
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", '--model_path', type=str, default="DCASE2019_task4/baseline/dcase2019_t4_mdl", dest="model_path",
