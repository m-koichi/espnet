...
if __name__ == '__main__':
    ...
    test_2018_df = dataset.initialize_and_get_df(cfg.test2018, reduced_number_of_data)
    ...
    train_weak_data = DataLoadDf(eval_2018_df, dataset.get_feature_file, many_hot_encoder.encode_strong_df,
                                 transform=transforms)
    train_weak_data = DataLoadDf(test_2018_df, dataset.get_feature_file, many_hot_encoder.encode_strong_df,
                                 transform=transforms)
    train_weak_data = DataLoadDf(validation_df, dataset.get_feature_file, many_hot_encoder.encode_strong_df,
                                 transform=transforms)
    ...
    filenames_train = synthetic_df.filename.drop_duplicates().sample(frac=0.99, random_state=26)
    ...
    transforms = get_transforms(cfg.max_frames, scaler=None, augment_type="noise")
